...
def simulate() -> None:
    ...
    t, u = mesh_2d(mesh=mesh, bc=bc, tf=100, theta=0.5, max_courant=0.5)
...
def mesh_2d(*, mesh:dict, bc:dict, tf:float, theta:float=0.5, max_courant:float=0.5) -> tuple[np.ndarray, np.ndarray]:  # pylint:disable=too-many-locals
    """
